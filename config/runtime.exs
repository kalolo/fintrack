...
config :fintrack, :invoice_config,
  client: %{
    ...
    city_state_zip: System.get_env("CLIENT_CITY_STATE_ZIP", "City, State ZIP"),
    ein: System.get_env("CLIENT_EIN", "Your-EIN-Number")
  },
  bill_to: %{
    name: System.get_env("BILL_TO_NAME", "Your Name"),
    swift_bic: System.get_env("BILL_TO_SWIFT_BIC", "SWIFT-BIC-CODE"),
    account_number: System.get_env("BILL_TO_ACCOUNT_NUMBER", "Account-Number"),
    bank_name: System.get_env("BILL_TO_BANK_NAME", "Bank Name"),
    bank_address: System.get_env("BILL_TO_BANK_ADDRESS", "Bank Address")
  }
