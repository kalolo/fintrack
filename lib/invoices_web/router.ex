defmodule InvoicesWeb.Router do
  ...
  pipeline :browser do
    ...
    plug InvoicesWeb.UserAuth, :fetch_current_user
  end
  ...
  scope "/", InvoicesWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{InvoicesWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", InvoicesWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{InvoicesWeb.UserAuth, :ensure_authenticated}] do
  ...
  pipeline :redirect_if_user_is_authenticated do
    plug InvoicesWeb.UserAuth, :redirect_if_user_is_authenticated
  end

  pipeline :require_authenticated_user do
    plug InvoicesWeb.UserAuth, :require_authenticated_user
  end
